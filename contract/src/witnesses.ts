...
/*
 * This file defines the shape of the Ataulfo's private state,
 * as well as the single witness function that accesses it.
 */

import { Ledger } from "./managed/ataulfo/contract/index.cjs";
import { WitnessContext } from "@midnight-ntwrk/compact-runtime";

/* **********************************************************************
 * The only hidden state needed by the Ataulfo contract is
...
export type AtaulfoPrivateState = {
 ...
 *  is the private state type, like AtaulfoPrivateState defined above.
 *
 ...
 * the declared return value.  In this case, that's a AtaulfoPrivateState
