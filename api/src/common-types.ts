 ...
 *
 * Since there is only one contract type for the Ataulfo example, we only define a
...
/**
 * Represents a Ataulfo contract and its private state.
 *
 * @public
 */
...
export type AtaulfoDerivedState = {
  ...
  readonly isContractOwner: boolean;
  readonly balance: bigint;
  readonly offersPublished: bigint;
};
